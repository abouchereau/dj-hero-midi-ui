...
module.exports =  class DeviceDJHero extends InputDevice {//abstract
    ...
    onPress(a) {
        ...
        this.manager.sendChange(a, "PRESS");
    }
    ...
    onRelease(a) {
        ...
        this.manager.sendChange(a, "RELEASE");
    }
    ...
    onFaderChange(a) {
        ...
        this.manager.sendChange("FADER", a);
    }
    ...
    onDiscChange(a) {
        ...
        this.manager.sendChange("DISC", a);
    }
    ...
    onKnobChange(a) {//values = 0,1,2,3
        this.knob = a+1;
        this.manager.sendChange("KNOB", this.knob);
    }
}
